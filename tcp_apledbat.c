...
EXPORT_SYMBOL_GPL(tcp_apledbat_cong_avoid);
...
static struct tcp_congestion_ops tcp_ledbat = {
  ...
  .cong_avoid = tcp_apledbat_cong_avoid,
  .name = "apledbat",
};
...
MODULE_AUTHOR("Kevin Ong, Mirja Kuehlewind");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("TCP LEDBAT (Apple)");
MODULE_VERSION("0.3");